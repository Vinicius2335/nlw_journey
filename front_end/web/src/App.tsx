        ...
        <div className="space-y-4">
          <div className="h-16 px-4 text-zinc-50 rounded-xl flex items-center shadow-shape gap-3">
            ...
            {isGuestsInputOpen ? (
              ...
              <button
                className="bg-lime-300 text-zinc-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400 transition-colors"
          ...
          {isGuestsInputOpen && (
            <div className="h-16 px-4 text-zinc-50 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <button className="bg-lime-300 text-zinc-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400 transition-colors">
                <ArrowRight className="size-5" />
                Confirmar Viagem
              </button>
            </div>
